...
export default function useResize(
  ...
  const movingIndexValue = computed(() => movingIndex.value?.index)

  return [onOffsetStart, onOffsetUpdate, onOffsetEnd, onCollapse, movingIndexValue] as const
}
